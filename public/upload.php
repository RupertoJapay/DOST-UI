        ...
        <div class="card phase1-card">
            ...
            <?php if ($message): ?>
                <div id="popup-message" class="alert alert-success text-center"
                    ...
                    <?= $message ?>
                    <br><br>
                    <button onclick="window.history.back()" class="btn btn-primary">Done</button>
                </div>
            <?php endif; ?>

            <form  method="POST" enctype="multipart/form-data" id="uploadForm" novalidate <?= $message ? 'style="display:none;"' : '' ?>>
                <label>Name:</label>
                ...
                <label class="form-label">Role (Participant, Facilitator, Resources Speaker etc.):</label>
                ...
                <br>
                <h2 class="form-title">Upload Supporting Documents</h2>
